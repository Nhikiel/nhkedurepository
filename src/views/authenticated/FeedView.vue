    ...
    <div v-else>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <div class="flex items-center space-x-4">
                ...
                />
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Welcome back, {{ getDisplayName() }}!</h1>
                    <p class="text-gray-600">{{ userProfile?.program || 'Student' }} • {{ userProfile?.role || 'Member' }}</p>
                    <p class="text-sm text-gray-500 mt-1">{{ userProfile?.about || 'Ready to learn and share knowledge!' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <div class="flex space-x-4">
                ...
                <textarea
                    rows="2"
                    :placeholder="`What's on your mind, ${userProfile?.firstName || 'there'}?`"
